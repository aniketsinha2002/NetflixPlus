...
const MovieDetails = () => {
  ...
  if (!movieDetails) {
    return <div className="text-white p-4 m-4 bg-gray-900 rounded-lg h-screen overflow-x-hidden border border-b-white">Loading...</div>;
  }
  ...
  return (
    <div className="text-white p-4 m-4 bg-gray-900 bg-opacity-50 rounded-lg h-screen overflow-x-hidden border border-b-white">
